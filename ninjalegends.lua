...
local window = library:AddWindow("Ninja Legends GUI | Scripted by PacMan#7499")
local tab = window:AddTab("Auto Farms")
local plrtab = window:AddTab("LocalPlayer")
...
local walkspeed = plrtab:AddSlider("WalkSpeed", function(ws)
...
walkspeed:Set(16)
local jumppower = plrtab:AddSlider("JumpPower", function(jp)
...
local autofarm = tab:AddSwitch("Auto Farm", function(bool)
    _G.farm = bool
    while _G.farm == true do
    wait()
    game.Players.LocalPlayer.saberEvent:FireServer("swingBlade")
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-80.7083359, 8649.74707, 36.9530754)
end
autofarm:Set(false)
end)

local coincollect = tab:AddSwitch("Auto Collect Coins (also a shard farm)", function(bool)
	_G.coinfarm = bool
while _G.coinfarm == true do
wait()
for i,v in pairs(game.Workspace.spawnedCoins["Shuriken City"]:GetChildren()) do
    if v.Name == "whichCoin" then
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(v.positionValue.Value)
    end
end
end
coincollect:Set(false)
end)

teleports:AddButton("Unlock All Islands", function()
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2.52,1467.24,70.32)
	wait(0.5)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0.19,3057.34,85.05)
	wait(0.5)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0.87,4681.34,68.68)
	wait(0.5)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(10.47,6311.44,75.81)
	wait(0.5)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(5.87,8631.83,98.67)
end)

local islands = teleports:AddDropdown("Teleport to Islands", function(object)
	if object == "Planet Zephyr" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2.52,1467.24,70.32)
	elseif object == "Planet Inferno" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0.19,3057.34,85.05)
	elseif object == "Planet Omega" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0.87,4681.34,68.68)
	elseif object == "Planet Elemental" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(10.47,6311.44,75.81)
	elseif object == "Planet Chaos" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(5.87,8631.83,98.67)
	end
end)
islands:Add("Planet Zephyr")
islands:Add("Planet Inferno")
islands:Add("Planet Omega")
islands:Add("Planet Elemental")
islands:Add("Planet Chaos")

local infjump = misc:AddButton("Infinite Jumps", function()
    game.Players.LocalPlayer.multiJumpCount.Value = 9e9
end)

local keybind = settings:AddKeybind("Show/Hide", function(obj)
...
local cp = settings:AddColorPicker(function(color)
	ui_options.main_color = color
end)

credits:AddLabel("Scripted by PacMan#7499 on Discord.")
credits:AddLabel("UI Library by Singularity")

tab:Show()
library:FormatWindows() -- Do not remove
